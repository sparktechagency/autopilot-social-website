      ...
      >
        ...
        >
          ...
          <div className="rounded-md bg-[#8EC5FF80] flex items-center justify-center p-4">
            <div className="w-16 h-8 bg-linear-to-r from-[#51A2FF] to-[#2B7FFF] rounded-sm" />
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="absolute bg-white rounded-2xl shadow-lg p-5 flex items-center gap-2"
        ...
        <motion.div
          ...
          className="absolute bg-[#FFFBEB] rounded-2xl shadow-lg p-4 flex items-center gap-3"
          style={{
        ...
        <motion.div
          ...
          className="absolute bg-[#F0FFF6] rounded-2xl shadow-lg px-4 py-4 min-w-40"
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex flex-col items-start">
              <div className="flex items-baseline gap-1.5">
                ...
                <span className="text-[11px] text-[#4A5565] font-normal">
                  items
                </span>
              </div>
              <span className="text-[11px] text-[#4A5565] mt-1 leading-tight">
                Sold this week
              </span>
              <span className="text-[22px] font-bold text-[#00A63E] mt-2 leading-none">
                $12
              </span>
            </div>
        ...
        <motion.div
          ...
          className="absolute bg-white rounded-2xl shadow-lg p-3 flex flex-col gap-3 min-w-44"
          style={{
        ...
        >
          ...
          <div className="flex flex-col gap-2">
            <p className="bg-[#0F172A] text-white font-bold text-xs px-3 py-1 rounded-full w-fit">
              1.5k
            </p>
