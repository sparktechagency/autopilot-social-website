      ...
      <Container maxWidth="xl" className="md:mt-20">
        ...
        <Box sx={{ textAlign: "center", mb: { xs: 6, md: 9 } }}>
          ...
          >
            ...
            easily promote their music and influencers can earn by sharing music
            they love.
          </Typography>
        </Box>
          ...
          <Grid size={{ xs: 12, md: 6 }}>
            ...
            >
              <Image
                ...
                className="lg:h-full! max-h-162.5! lg:w-full! rounded-2xl"
                priority
              />
            </Box>
          </Grid>
        ...
        >
          ...
          infrastructure, and a &quot;compliance-first&quot; engagement strategy
          to give you the presence of a full-scale agency for the price of a
